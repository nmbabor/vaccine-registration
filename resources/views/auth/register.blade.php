<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-8 max-w-lg mx-auto">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nid" class="block mt-1 w-full" type="text" name="nid" pattern="[0-9]{13,}" 
                          title="Please enter a valid NID with at least 13 digits." :value="old('nid')" required />
